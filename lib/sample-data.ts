...
export function generateSampleData(type: "products" | "keywords" | "sales", count = 10) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    if (type === "products") {
      ...
      baseItem.revenue = Number.parseFloat((baseItem.price * baseItem.stock).toFixed(2))
      ...
      baseItem.revenue = Number.parseFloat((Math.random() * 2000 + 100).toFixed(2))
