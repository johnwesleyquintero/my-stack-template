  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Enter your data manually or paste from another source
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs
          value={activeTab}
          onValueChange={value => setActiveTab(value as 'json' | 'csv')}
        >
            ...
            <Alert>
              ...
              <AlertDescription>
                <ul className="list-inside list-disc text-sm">
                  ...
                  <li>
                    Validate your JSON with a tool like JSONLint if you
                    encounter errors
                  </li>
                </ul>
              </AlertDescription>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => downloadSampleData('csv')}
                >
                  <Download className="mr-2 h-4 w-4" />
                  Download Template
                </Button>
